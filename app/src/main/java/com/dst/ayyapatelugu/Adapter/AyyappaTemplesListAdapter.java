...
public class AyyappaTemplesListAdapter extends RecyclerView.Adapter<AyyappaTemplesListAdapter.MyviewHolder> {
    Context mContext;
    List<TemplesListModel> listModels;
    public AyyappaTemplesListAdapter(HomeActivity homeActivity, List<TemplesListModel> templesListModels) {
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(mContext).inflate(R.layout.temple_list_adapter,parent,false);
        return new AyyappaTemplesListAdapter.MyviewHolder(view);
    }

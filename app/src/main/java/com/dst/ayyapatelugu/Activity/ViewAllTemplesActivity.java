...
public class ViewAllTemplesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_temples);
       ...
       /* toolbar.setLogo(R.drawable.user_profile_background);
        ...
        imageAnadanam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ViewAllTemplesActivity.this,AnadanamActivity.class);
        ...
        txtNityaPooja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ViewAllTemplesActivity.this, NityaPoojaActivity.class);
                startActivity(intent);
